...
import image4 from "/public/images/small/img-4.jpg";
import image5 from "/public/images/small/img-5.jpg";
              ...
              <SimpleBar style={{ height: "300px" }} className="px-3 mx-n3 mb-2">
                <div className="d-flex mb-4">
                  ...
                  <div className="flex-grow-1 ms-3">
                    ...
                    <p className="text-muted">
                      I am getting message from customers that when they place order always get
                      error message .
                    </p>
                    <Link href="#">
                      <a className="badge text-muted bg-light">
                    ...
                    <div className="d-flex mt-4">
                      ...
                      <div className="flex-grow-1 ms-3">
                        <h5 className="fs-13">
                          Alexis Clarke{" "}
                          <small className="text-muted ms-2">22 Dec 2021 - 02:32PM</small>
                        </h5>
                        <p className="text-muted">
                          Please be sure to check your Spam mailbox to see if your email filters
                          have identified the email from Dell as spam.
                        </p>
                        <Link href="#">
                          <a className="badge text-muted bg-light">
                            <i className="mdi mdi-reply"></i> Reply
                ...
                <div className="d-flex mb-4">
                  ...
                  <div className="flex-grow-1 ms-3">
                    ...
                    <p className="text-muted">
                      If you have further questions, please contact Customer Support from the
                      “Action Menu” on your{" "}
                      <Link href="#">
                        <a className="text-decoration-underline">Online Order Support</a>
                      </Link>
                      .
                    </p>
                    <Link href="#">
                ...
                <div className="border rounded border-dashed p-2">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="flex-grow-1 overflow-hidden">
                      <h5 className="fs-13 mb-1">
                        <Link href="#">
                          <a className="text-body text-truncate d-block">bg-pattern.png</a>
                        </Link>
                      </h5>
                      <div>1.1MB</div>
                    </div>
